...
```
## Getting Started
In order to use signed methods you need a [Binance account](https://www.binance.com/register.html), if you already have one, go to your account and create a new API private key.
